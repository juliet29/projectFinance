...
class ExpensesMixin:
    ...
    def calc_const_exp(self, new_val=None):
        ...
        self.construction_expense_df = const_df_base
    ...
    def calc_op_exp(self):
        ...
        # decade one 
        op_df.iloc[op_df.index.get_level_values(1)=="Monthly HIPU Interconection Fee, Decade 1", 3:3+10] = op_ref.loc[("Operating Fees to External Entities", "Monthly HIPU Interconection Fee, Decade 1"),"Value"]*12
        # decade two 
        op_df.iloc[op_df.index.get_level_values(1)=="Monthly HIPU Interconection Fee, Decade 1", 3+10:] = op_ref.loc[("Operating Fees to External Entities", "Monthly HIPU Interconection Fee, Post-Decade 1"),"Value"]*12
        # rename
        ...
        self.operating_expense_df = op_df
    ...
    def calc_corp_exp(self):
        ...
        self.corporate_expense_df = corp_df
